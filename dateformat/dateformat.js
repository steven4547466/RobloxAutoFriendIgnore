...
module.exports.dateFormat = function(date, mask, utc, gmt) {
    ...
    mask = String(module.exports.masks[mask] || mask || module.exports.masks["default"]);
    ...
    var flags = {
        ...
        ddd: function ddd() {
            return module.exports.i18n.dayNames[D()]
        },
        DDD: function DDD() {
            return getDayName({
                y: y(),
                ...
                d: _d(),
                _: _(),
                dayName: module.exports.i18n.dayNames[D()],
                short: true
            })
        },
        dddd: function dddd() {
            return module.exports.i18n.dayNames[D() + 7]
        },
        DDDD: function DDDD() {
            return getDayName({
                y: y(),
                ...
                d: _d(),
                _: _(),
                dayName: module.exports.i18n.dayNames[D() + 7]
            })
        },
        m: function m() {
            return _m() + 1
        ...
        mmm: function mmm() {
            return module.exports.i18n.monthNames[_m()]
        },
        mmmm: function mmmm() {
            return module.exports.i18n.monthNames[_m() + 12]
        },
        yy: function yy() {
        ...
        t: function t() {
            return _H() < 12 ? module.exports.i18n.timeNames[0] : module.exports.i18n.timeNames[1]
        },
        tt: function tt() {
            return _H() < 12 ? module.exports.i18n.timeNames[2] : module.exports.i18n.timeNames[3]
        },
        T: function T() {
            return _H() < 12 ? module.exports.i18n.timeNames[4] : module.exports.i18n.timeNames[5]
        },
        TT: function TT() {
            return _H() < 12 ? module.exports.i18n.timeNames[6] : module.exports.i18n.timeNames[7]
        },
        Z: function Z() {
...
module.exports.formatTimezone = function(date) {
